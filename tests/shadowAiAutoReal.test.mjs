...
test("prompt/runtime v7 distingue resolución 3A canónica sin reanalizar completed o failed previos", () => {
  assert.equal(REAL_SHADOW_AUTO_AI_PROMPT_VERSION,"administradora-ia-emporio-real-shadow-v7");
