...
export const nav = [
  ...
  { id: "tareas_recurrentes", label: "Mantenimiento Programado", icon: "🔁", link: "/operaciones/tareas-recurrentes", modulo: "operaciones_work_center", rolesPermitidos: ["admin", "coord_operaciones"] },
  { id: "coordinador_ia_sombra", label: "Coordinador IA — Sombra", icon: "🌒", link: "/coordinador-ia-sombra", modulo: "operaciones_work_center", rolesPermitidos: ["admin", "coord_operaciones"] },
