...
const CONCEPTOS = {
  ...
  gasto_juridico: 'Gasto jurídico', historico_validado: 'Histórico validado',
  no_bi: 'Fuera de BI', otro: 'Otro',
}
...
export default function TabCajaPoliza({ movimientos, onReload, esAdmin }) {
