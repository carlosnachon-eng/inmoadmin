...
export async function generarPolizaJuridica(exp) {
  ...
  const children = [
    ...
    // CARÁTULA
    // ══════════════════════════════════════════════════════
    centrado([bold('PÓLIZA JURÍDICA INMOBILIARIA', 28)]),
    ...espacio(1),

    // Datos de la póliza
    centrado([bold('DATOS DE LA PÓLIZA', 20)]),
    ...espacio(1),
    ...
    centrado([bold('DATOS DEL PROPIETARIO', 20)]),
    ...espacio(1),
    ...
    centrado([bold('DATOS DEL ARRENDATARIO', 20)]),
    ...espacio(1),
    ...
    // Datos del inmueble
    centrado([bold('DATOS DEL INMUEBLE ARRENDADO', 20)]),
    ...espacio(1),
    ...
    // Datos del contrato
    centrado([bold('DATOS DEL CONTRATO DE ARRENDAMIENTO', 20)]),
    ...espacio(1),
    ...
    // Observaciones
    centrado([bold('OBSERVACIONES IMPORTANTES', 20)]),
    ...espacio(1),
    para([
    ...
    divider(),
    ...espacio(1),
    centrado([bold('EMPORIO INMOBILIARIO', 20)]),
