    ...
    sections: [{
      ...
      children: [
        ...
        para([
          ...
          normal(' y al '),
          bold('VENDEDOR'),
          normal(' de cualquier responsapabilidad por vicios ocultos o las posibles averías que el bien manifieste después de 30 dias de la presente entrega.'),
        ]),
        para([
          normal('De igual forma, '),
          bold('LAS PARTES'),
          normal(' establecen que en caso de sucitarse algún tema por lo establecido en el párrafo inmediato anterior, '),
          bold('LOS COMPRADORES'),
