...
export const shadowContextTools = Object.freeze({
  resolve_contact_identity: async (db, respondContactId) => {
    ...
    return [
      { entityType: "contact_identity", internalId: identity.linkId, status: "confirmed", resolved: true, linkSource: identity.linkSource, roles: identity.roles, ambiguousPropertyContext: identity.ambiguousPropertyContext },
