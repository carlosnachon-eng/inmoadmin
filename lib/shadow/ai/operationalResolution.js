...
export const SHADOW_OPERATIONAL_RESOLUTION_VERSION = "shadow-operational-resolution-v3";
...
const relevantToolNames = Object.freeze({
  ...
  administrative_pending: new Set(["resolve_contact_identity", "get_work_center_case"]),
});
