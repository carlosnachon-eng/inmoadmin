...
import { buildConversationAction, semanticConversationGuard, SHADOW_CONVERSATION_DOMAINS } from "./conversationAction.js";
...
function replayNoMessageForUnsupportedDomain(resolution, now) {
  return {
    version: "shadow-conversation-action-v1", case_domain: resolution?.case_domain,
