...
function chooseAction(resolution, decision) {
  ...
  if (resolution?.case_status === "no_message") return "no_message";
...
export function renderConversationAction(action) {
  ...
  const rendered = {
    ...
    acknowledge_received_information: independentKind === "information_received"
      ...
      : independentKind === "document_received"
        ...
        : independentKind === "maintenance_evidence_received"
