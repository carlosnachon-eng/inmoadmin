...
export function finalizeShadowAiDecision(decision, envelope, tools) {
  ...
  const commitmentCandidate = `${decision.proposedAction} ${responsePartText(decision)}`;
