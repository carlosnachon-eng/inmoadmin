...
export function minimalShadowAiContext(envelope, deterministic, toolResults, round) {
  return {
    ...
    metadata: Object.fromEntries(Object.entries(envelope.providerMetadata || {}).filter(([key]) => ["area","service","subject","contactRole","authorRole","turnAuthorRole","propertyReference","propertyId","contractId","paymentId","serviceId","ticketId","keyId","ownerPaymentId","workCenterContextKey","syntheticScenario","priorConversation","attachmentContext"].includes(key))),
    deterministic: { intent: deterministic?.intent, interactionDirection: deterministic?.interactionDirection || "ambiguous_actor", requiresHuman: deterministic?.requiresHuman, reasonCodes: deterministic?.reasonCodes || [] },
