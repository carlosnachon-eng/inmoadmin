...
export async function runShadowAi(admin, { messageId, envelope, deterministic }, options = {}) {
  ...
  const telemetry = { schema_version: SHADOW_AI_OUTPUT_SCHEMA_VERSION, prompt_version: SHADOW_AI_PROMPT_VERSION, anthropic_requests: [], tools: [], rounds: [], total_run_duration_ms: null, timeout_stage: null };
  try {
