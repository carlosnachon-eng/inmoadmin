...
export function minimalShadowAiContext(envelope, deterministic, toolResults, round) {
  return {
    ...
    metadata: Object.fromEntries(Object.entries(envelope.providerMetadata || {}).filter(([key]) => ["area","service","subject","contactRole","propertyReference","propertyId","contractId","paymentId","serviceId","ticketId","keyId","ownerPaymentId","workCenterContextKey","syntheticScenario","priorConversation"].includes(key))),
