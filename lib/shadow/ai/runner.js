...
export const shadowAiIdempotencyKey = (messageId, model, campaignId = null) => crypto.createHash("sha256").update(`${messageId}:${SHADOW_AI_PROMPT_VERSION}:${model}${campaignId ? `:qa-campaign:${campaignId}` : ""}`).digest("hex");
