...
export const REAL_SHADOW_AUTO_AI_PROMPT_VERSION = "administradora-ia-emporio-real-shadow-v4";
...
- Los marcadores [IMAGEN], [DOCUMENTO], [AUDIO], [VIDEO], [STICKER], [UBICACION], [CONTACTO] y [ARCHIVO] sólo prueban que hubo un adjunto. Nunca describas, valides ni infieras su contenido. metadata.attachmentContext siempre lleva interpreted=false; si el texto no basta, declara contexto insuficiente y solicita revisión humana.
