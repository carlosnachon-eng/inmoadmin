...
export function generarReciboComisionPdf({ cierre, pagos = [], emitidoPor = null, propiedad = null, propietario = null, recibo = null }) {
  ...
  const direccion = direccionPropiedad(propiedad) || safeText(recibo?.inmueble) || safeText(cierre.direccion_inmueble) || "—";
  ...
  drawLabelValue(doc, "Asesor", cierre.vendedor || "—", 220, 538, 160);
  drawLabelValue(doc, "Monto comisión", fmt(cierre.comision), 390, 538, 150);
