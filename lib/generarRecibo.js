...
export async function generarReciboPoliza(exp) {
  ...
  const doc = new Document({
    ...
    sections: [{
      properties: {
        page: {
          size: { width: 7920, height: 12240 },
          margin: { top: 1440, right: 1200, bottom: 800, left: 1200 },
        },
      },
      children: [
        // Título
            ...
            new TableRow({
              children: [
                new TableCell({
                  ...
                  shading: { fill: 'F5F5F5' },
                  margins: { top: 60, bottom: 60, left: 100, right: 60 },
                  children: [new Paragraph({ children: [new TextRun({ text: 'Inmueble:', size: 16, font: FONT, color: GRIS })], spacing: { before: 0, after: 0 } })],
                }),
                new TableCell({
                  borders: noBorders,
                  width: { size: 3800, type: WidthType.DXA },
                  margins: { top: 60, bottom: 60, left: 100, right: 60 },
                  children: [new Paragraph({ children: [new TextRun({ text: d.inmueble, size: 14, font: FONT, color: NEGRO })], spacing: { before: 0, after: 0 } })],
                }),
              ],
            }),
