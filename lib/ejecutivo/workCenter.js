...
export const RESPOND_IO_WORKSPACE_ID_DEV = "411886";
...
function respondInboxLink(contactId) {
  return contactId ? `https://app.respond.io/space/${RESPOND_IO_WORKSPACE_ID_DEV}/inbox/${encodeURIComponent(String(contactId))}` : null;
}
