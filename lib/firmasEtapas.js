export const ETAPAS_ARRENDAMIENTO = [
  ...
  { orden: 3,  clave: 'aviso_dueno',      nombre: 'Aviso al dueno + coordinacion inicial', responsable: 'administracion' },
  ...
  { orden: 9,  clave: 'revision_majo',    nombre: 'Contrato enviado a revision — Administracion lo envia al propietario', responsable: 'administracion' },
  { orden: 10, clave: 'observaciones',    nombre: 'Observaciones resueltas',                       responsable: 'juridico' },
  { orden: 11, clave: 'firma_programada', nombre: 'Firma programada (Juridico + Ventas + Administracion)',   responsable: 'juridico' },
