    ...
    if (tipo === 'contado') {
      return [
        para([
          ...
          bold(d.pago3_fecha ? d.pago3_fecha.toUpperCase() : '_______________'),
    ...
    sections: [{
      ...
      children: [
        ...
        para([
          ...
          normal(', que en lo sucesivo denominado '),
          bold('"EL INMUEBLE"'),
          normal('; y quienes '),
          italic('"Bajo Protesta de Decir Verdad"'),
          normal('; manifiestan:'),
        ...
        para([
          ...
          normal('El señor '),
          bold(d.nombre_vendedor.toUpperCase()),
          normal(', mexicano por nacimiento'),
        ...
        para([
          ...
          bold(d.pago1_fecha.toUpperCase()),
          normal('.'),
        ], { indent: { left: 360 } }),
        espacio(),
        para([
        ...
        espacio(),
        para([normal('Cantidad que se recibe y en esa inteligencia, el Promitente Vendedor otorga el recibo más amplio que en derecho proceda.')], { indent: { left: 360 } }),
        espacio(),
        ...
        ...(d.pago2_monto ? [
          para([
            ...
            normal(', que se entregarán el día '),
            bold(d.pago2_fecha ? d.pago2_fecha.toUpperCase() : '_______________'),
            normal('.'),
          ], { indent: { left: 360 } }),
          espacio(),
        ] : []),
        ...
        espacio(),
        para([bold('a) '), normal('Realizar la reparación total de las humedades existentes, eliminando cualquier indicio de humedad activa en el inmueble.')], { indent: { left: 360 } }),
        espacio(),
        para([bold('b) '), normal('Entregar el inmueble en condiciones funcionales de uso, incluyendo, pero no limitando a instalaciones hidráulicas, sanitarias y eléctricas, tuberías, drenajes, ventanas, puertas, portón eléctrico y equipos en correcto funcionamiento y en condiciones normales de uso.')], { indent: { left: 360 } }),
        espacio(),
        para([bold('c) '), normal('En caso de existir cualquier defecto, falla o desperfecto que no haya sido corregido, el Promitente Vendedor deberá notificarlo previamente al Promitente Comprador antes de la firma, a efecto de que ambas partes acuerden, en su caso, un ajuste en el precio de compraventa.')], { indent: { left: 360 } }),
        espacio(),
        para([bold('d) '), normal('Entregar el inmueble libre de adeudos por concepto de impuesto predial, agua, energía eléctrica, gas y cualquier otro servicio.')], { indent: { left: 360 } }),
        espacio(),
