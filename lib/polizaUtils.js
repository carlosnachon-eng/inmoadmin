...
export const STATUS_LABELS = {
  ...
  rechazada:   { label: 'Rechazada',   color: C.redText,   bg: C.redBg },
  aprobado:    { label: 'Aprobado',    color: C.greenText, bg: C.greenBg },
  aprobada:    { label: 'Aprobada',    color: C.greenText, bg: C.greenBg },
  ...
  revision:    { label: 'En revisión', color: C.blueText,  bg: C.blueBg },
}
