      ...
      <div style={{ background: "#1a1a2e", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            ...
            <h1 style={{ margin: 0, fontSize: 20, fontWeight: 800, color: "#fff" }}>📋 Contratos ({contracts.length})</h1>
          </div>
        </div>
        <Btn color="#c8a96e" onClick={() => { setForm(emptyForm); setEditing(null); setShowModal(true); }}>+ Nuevo</Btn>
      </div>
