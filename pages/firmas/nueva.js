      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={card}>
          ...
          <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', marginTop: '0.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <input type="checkbox" id="propietario" checked={form.propietario_asiste} onChange={e => set('propietario_asiste', e.target.checked)} />
              <label htmlFor="propietario" style={{ fontSize: '0.9rem', color: '#555' }}>Propietario asiste a la firma</label>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
