...
// ═══════════════════════════════════════════════════════════
function TabExpedientes({ expedientes, propietarios, solicitudes, onSelect, onReload, onRenovar }) {
...
// MODAL RENOVACIÓN
// ═══════════════════════════════════════════════════════════
function ModalRenovacion({ expediente: e, onClose, onSaved }) {
  ...
  const handleRenovar = async () => {
    ...
    try {
      ...
      // Marcar expediente anterior como renovado
      await supabase
        .from('poliza_expedientes')
