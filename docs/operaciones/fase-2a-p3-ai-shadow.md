...
- Prompt: `administradora-ia-emporio-v5`. El cambio de versión conserva separados los runs auditados bajo los contratos anteriores; `p3-11` no se reejecutó durante este ajuste.
